...
public class Students   {
    ArrayList<Students> transaction=new ArrayList<Students>();
...
public void print_Details(){
    ...
    public ArrayList<Students> getTransaction() {
        return transaction;
    }
    public void setTransaction(ArrayList<Students> transaction) {
